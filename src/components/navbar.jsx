...
const Navbar = () => {
  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      {/* LOGO */}
      <div className="md:hidden lg:flex xl:w-1/3 xl:justify-center mb-3">
        <Link
          href="/"
        >
          <Image alt="logo_" src="/logo2.png" width={130} height={130}/>
        </Link>
      </div>
      {/* SOCIAL */}
      ...
      <div className="md:hidden">
        ...
        {open && (
          <motion.div
            ...
            initial="closed"
            animate="opened"
            className="absolute top-0 left-0 w-screen h-screen bg-red text-white flex flex-col items-center justify-center gap-8 text-4xl z-40"
          >
            {links.map((link) => (
              <motion.div
